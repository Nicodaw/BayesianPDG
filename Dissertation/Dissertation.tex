...
\begin{equation}
  ...
  P(R,L,S,D,N) = P(R, L) \prod_{i=1}^{\mid R \mid} P(S_i}, D_i, N_i)
\end{equation}
...
%TODO: Add a row for a completely random generator. One where it uses all uniform probabilities
\chapter{Results}
\label{cha:results}
...
%TODO: Consider the design, ethics and explain Qualtrics ?
\chapter{Discussion}
